...
Most importantly: your home directory is not persitent. Make yourself a work directory in `/user/scratch14_ppmstar`. Clone the repository into that work space using the command line.
